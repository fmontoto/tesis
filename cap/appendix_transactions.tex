  ...
  outputs: {
    {
      ...
      script_length: 23
      script: [OP_HASH160
                OP_PUSH_20_bytes DB462EBE7EA4EA37B33C55A1B2F0C248D0A09EDE
                OP_EQUAL]
    }
    {
      value: 92281150
      script_length: 23
      script: [OP_HASH160
                OP_PUSH_20_bytes 2F94430868831770263A816A38DB1CAB1CACC6C1
                OP_EQUAL]
    }
    {
      value: 3000000
      script_length: 23
      script: [OP_HASH160
               OP_PUSH_20_bytes C51CC859AAF8964EC4542B6A2325A1313CA5E528
               OP_EQUAL]
    }
    {
      value: 3000000
      script_length: 23
      script: [OP_HASH160
                OP_PUSH_20_bytes 4633E6CCC1C019D443EF2D8B07B626A1476C086B
                OP_EQUAL]
    }
    {
      value: 3000000
      script_length: 23
      script: [OP_HASH160
                OP_PUSH_20_bytes 978CD4A4FC0E1E3D6837466F5ABD0729AF487A07
                OP_EQUAL]
    }
    {
      value: 3000000
      script_length: 23
      script: [OP_HASH160
                OP_PUSH_20_bytes 5D1CF6559FCB6ADB8752AA2F25AE6BB71FC7E798
                OP_EQUAL]
    }
    {
      value: 3000000
      script_length: 23
      script: [OP_HASH160
                OP_PUSH_20_bytes 753C630FA29D3DB021B3447E27B181378F5B4B1D
                OP_EQUAL]
    }
    {
      value: 3000000
      script_length: 23
      script: [OP_HASH160
                OP_PUSH_20_bytes 6259C5769F46E4450B5F1BF37A96CF7AD1F67446
                OP_EQUAL]
    }
    {
      value: 3000000
      script_length: 23
      script: [OP_HASH160
                OP_PUSH_20_bytes E28F8576E8785436E0E181A72E2B5A82E3A44D10
                OP_EQUAL]
    }
    {
      value: 3000000
      script_length: 23
      script: [OP_HASH160
                OP_PUSH_20_bytes FED90167EA434BDFCFF57200EBFF36F8378B9149
                OP_EQUAL]
    }
    {
      value: 3000000
      script_length: 23
      script: [OP_HASH160
                OP_PUSH_20_bytes 650261902037C28A9B79A2ADAC4F7C347F01F920
                OP_EQUAL]
    }
    {
      value: 3000000
      script_length: 23
      script: [OP_HASH160
                OP_PUSH_20_bytes F40AA165879099585B01896A7EB07D24CCD65F97
                OP_EQUAL]
    }
  }
  lock_time: 0
...
First two inputs spend the the second and third output at the Bet Promise
  transaction.
...
\subsection{Winner Prize Collect}
\begin{lstlisting}
{
  version: 2
  inputs counter: 2
...

]
      sequence_no: 4194810
    }
  }
  ...
  outputs: {
    {
      value: 184385480
      script_length: 25
      script: [OP_DUP, OP_HASH160, OP_PUSH_20_bytes, 66E2E39AB1C5E98A8180DE876CC4743D3292E14A, OP_EQUALVERIFY, OP_CHECKSIG]
    }
  }
  lock_time: 0
}
