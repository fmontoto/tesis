...
%What if you would like to gamble in a event that no gambling site offers nor any
%  friend want to. Probably the internet would be the place to look for somebody
%  willing to gamble on this event. However, how could you trust the potential
%  person in order to bet with him? This work proposes a protocol to bet with
%  any strange, with no need to trust him.
